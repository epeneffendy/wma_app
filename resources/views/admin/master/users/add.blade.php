                ...
                <div class="card-body pt-2 mt-1">
                    ...
                    @csrf
                        ...
                        <div class="col-md-6">
                            ...
                            <input class="form-control" type="text" id="name" name="name" value="" placeholder="Name" autofocus />
                        ...
                        <div class="col-md-6">
                            <div class="form-floating form-floating-outline">
                            <input type="text" class="form-control" id="re-password" name="re-password" value="" placeholder="Re Enter Password"/>
                            <label for="re-password">Re-Type Password</label>
                            </div>
                        </div>
                        </div>
                        <div class="mt-4">
                        <button type="submit" class="btn btn-primary me-2"><span class="tf-icons mdi mdi-content-save-check me-1"></span>Primary</button>
                        </div>
                  </form>
                </div>
              </div>
