            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        <h5 class="card-title m-0 me-2">List Product Retur</h5>
                        <a href="{{route('admin.transaction.product_retur.add')}}"
                           class="btn btn-primary"><span
                                class="tf-icons mdi mdi mdi-swap-horizontal-bold me-1"></span>Add Retur</a>
                    </div>
                    <div class="card-body">
                        @if (session('message'))
